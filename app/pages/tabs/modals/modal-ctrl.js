angular.module('myApp.modals', [])
    .controller('BayEditModalCtrl', function($uibModalInstance, $rootScope, items, utility, BayService, LoaderService) {
        var $ctrl = this;
        ...
        $ctrl.update = function() {
            ...
            let bay = { 'bayName': $ctrl.bay.bayName, 'bayNum': $ctrl.bay.bayNum, 'bayType': $ctrl.bay.bayType, 'functionalStatus': $ctrl.bay.functionalStatus, 'editbayNumFlag': editbayNumFlag, 'editbayNameFlag': editbayNameFlag, 'bayId': $ctrl.bay.bayId, 'userName': $rootScope.user.name }
...
.controller('LocationEditModalCtrl', function($uibModalInstance, items, LocationService, LoaderService) {
    ...
    $ctrl.update = function() {
        ...
        //$uibModalInstance.close($ctrl.selected.item);
        let location = { "locationName": $ctrl.location.locationName, "locationCode": $ctrl.location.locationCode, "operationalStatus": $ctrl.location.operationalStatus, "locationAddress": $ctrl.location.locationAddress, "state": $ctrl.location.state, "city": $ctrl.location.city, "pinCode": $ctrl.location.pinCode, "locationId": $ctrl.location.locationId, "editLocationNameFlag": editLocationNameFlag, "editLocationCodeFlag": editLocationCodeFlag, 'userName': $rootScope.user.name };
...
.controller('QuantityEditModalCtrl', function($uibModalInstance, items, QuantityService, LoaderService) {
    ...
    $ctrl.update = function() {
        ...
        //$uibModalInstance.close($ctrl.selected.item);
        let quantity = { "quantityName": $ctrl.quantity.quantityName, "quantity": $ctrl.quantity.quantity, "quantityStatus": $ctrl.quantity.operationalStatus, "editQuantityFlag": editQuantityFlag, "editQuantityNameFlag": editQuantityNameFlag, "quantityId": $ctrl.quantity.qunatityId, 'userName': $rootScope.user.name };
